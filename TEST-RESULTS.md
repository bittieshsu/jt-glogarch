...
| **Status** | ✅ ALL PASSED |
| **Version** | v1.13.20 |
| **Date** | 2026-07-23 08:49:25 UTC |
| **Platform** | Python 3.10.12 / Linux 5.15.0-185-generic x86_64 |
| **Results** | 285 passed  / 1 skipped in 32.42s |
| **Version Check** | ✅ OK |
...
tests/test_audit.py::test_cleanup_uses_audit_retention 2026-07-23 16:49:28 [info     ] No archives to clean up        retention_days=1095
2026-07-23 16:49:28 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-23 16:49:28 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
2026-07-23 16:49:28 [info     ] No archives to clean up        retention_days=1095
2026-07-23 16:49:28 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
tests/test_audit.py::test_cleanup_audit_no_config 2026-07-23 16:49:28 [info     ] No archives to clean up        retention_days=1095
2026-07-23 16:49:28 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-23 16:49:28 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
...
tests/test_db_rebuild.py::test_rebuild_dry_run 2026-07-23T08:49:32.393400Z [info     ] Would insert                   path=/tmp/tmpn8d992cc/archives/server1/2026/01/test.json.gz server=test time_from=2026-01-01T00:00:00Z
PASSED
...
tests/test_export_pagination.py::test_deep_pagination_no_same_ms_loss_or_dup 2026-07-23T08:49:33.064918Z [info     ] Total messages to fetch        total=6
2026-07-23T08:49:33.066577Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=4 new_from='2024-01-01 00:00:00.003000' old_from='2024-01-01 00:00:00'
PASSED
tests/test_export_pagination.py::test_deep_pagination_multiple_windows 2026-07-23T08:49:33.072925Z [info     ] Total messages to fetch        total=30
2026-07-23T08:49:33.076098Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=6 new_from='2024-01-01 00:00:00.005000' old_from='2024-01-01 00:00:00'
2026-07-23T08:49:33.079419Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=11 new_from='2024-01-01 00:00:00.010000' old_from='2024-01-01 00:00:00.005000'
2026-07-23T08:49:33.082549Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=16 new_from='2024-01-01 00:00:00.015000' old_from='2024-01-01 00:00:00.010000'
2026-07-23T08:49:33.085729Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=21 new_from='2024-01-01 00:00:00.020000' old_from='2024-01-01 00:00:00.015000'
2026-07-23T08:49:33.088935Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=26 new_from='2024-01-01 00:00:00.025000' old_from='2024-01-01 00:00:00.020000'
PASSED
tests/test_export_pagination.py::test_pagination_raises_on_unsplittable_ms 2026-07-23T08:49:33.096392Z [info     ] Total messages to fetch        total=10
PASSED
...
tests/test_export_pagination.py::test_transient_5xx_fails_over_to_next_host 2026-07-23T08:49:33.119586Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-23T08:49:33.124313Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-23T08:49:33.127364Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-23T08:49:33.130372Z [info     ] Failover to host               host=http://host1:9200
PASSED
tests/test_export_pagination.py::test_all_hosts_transient_raises 2026-07-23T08:49:33.142559Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-23T08:49:33.144411Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-23T08:49:33.144760Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-23T08:49:33.147119Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=1 status=503 wait=1
2026-07-23T08:49:33.147419Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=2 status=503 wait=2
2026-07-23T08:49:33.147658Z [warning  ] Transient errors exhausted, failing over to next host host=http://host1:9200 status=503
PASSED
...
tests/test_health_guard.py::test_pause_then_resume 2026-07-23T08:49:33.394238Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 95%（超過硬上限 90%）']
2026-07-23T08:49:33.394396Z [info     ] export resumed — backpressure cleared waited_sec=1
PASSED
tests/test_health_guard.py::test_pause_times_out_and_raises 2026-07-23T08:49:33.396520Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 99%（超過硬上限 90%）']
2026-07-23T08:49:33.396660Z [error    ] export stopped — backpressure did not clear signals=['JVM heap 99%（超過硬上限 90%）'] waited_sec=60
PASSED
...
tests/test_import_jvm_throttle.py::test_failed_check_before_ever_working_does_not_deadlock 2026-07-23T08:49:33.410426Z [warning  ] Journal endpoint unreachable; import proceeds at user rate without journal throttling error=404
PASSED
tests/test_import_jvm_throttle.py::test_failed_check_after_working_is_failsafe_pause 2026-07-23T08:49:33.412214Z [warning  ] Journal check failed mid-import (target unreachable/stuck) — pausing until it recovers error=timeout
PASSED
...
tests/test_index_set_coverage.py::test_restricting_reports_skipped_index_sets 2026-07-23T08:49:33.442385Z [warning  ] Index sets NOT covered by this OpenSearch export — their logs will NOT be archived and will be lost when Graylog retention deletes them covered=['graylog'] skipped=['PVE Hosts', 'Wazuh']
PASSED
...
tests/test_integration.py::test_archive_write_read_integrity 2026-07-23T08:49:34.990979Z [info     ] Archive written                messages=50 path=/tmp/tmpw_84jftf/test/stream1/2026/01/01/test_stream1_20260101T000000Z_20260101T010000Z_001.json.gz size_mb=0.00
PASSED
...
tests/test_integrity.py::test_verifier_flags_tampered 2026-07-23T08:49:36.150406Z [info     ] Verification started           total_archives=1
2026-07-23T08:49:36.151622Z [error    ] TAMPERED archive (HMAC mismatch) archive_id=1 path=/tmp/pytest-of-root/pytest-31/test_verifier_flags_tampered0/a.json.gz
2026-07-23T08:49:36.158453Z [info     ] Verification completed         corrupted=0 missing=0 orphans=0 tampered=1 total=1 valid=0
PASSED
...
tests/test_storage_ownership.py::test_fix_dir_ownership_as_root 2026-07-23T08:49:58.240966Z [warning  ] Fixing directory ownership     new_owner=jt-glogarch path=/tmp/tmp96uye32i/archives/log4
PASSED
...
======================= 285 passed, 1 skipped in 32.42s ========================
```

## Version Check

```
Canonical version: 1.13.20
OK: version '1.13.20' has exactly one source of truth.
```
