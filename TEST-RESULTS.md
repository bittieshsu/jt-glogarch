...
| **Status** | ✅ ALL PASSED |
| **Version** | v1.13.11 |
| **Date** | 2026-07-12 08:07:24 UTC |
| **Platform** | Python 3.10.12 / Linux 5.15.0-179-generic x86_64 |
| **Results** | 260 passed  / 1 skipped in 22.95s |
| **Version Check** | ✅ OK |
...
tests/test_audit.py::test_cleanup_uses_audit_retention 2026-07-12 16:07:26 [info     ] No archives to clean up        retention_days=1095
2026-07-12 16:07:26 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-12 16:07:26 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
2026-07-12 16:07:26 [info     ] No archives to clean up        retention_days=1095
2026-07-12 16:07:26 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
tests/test_audit.py::test_cleanup_audit_no_config 2026-07-12 16:07:27 [info     ] No archives to clean up        retention_days=1095
2026-07-12 16:07:27 [info     ] Cleaned audit records          deleted=1 retention_days=180
2026-07-12 16:07:27 [info     ] Cleanup completed              bytes_freed=0 files_deleted=0
PASSED
...
tests/test_db_rebuild.py::test_rebuild_dry_run 2026-07-12T08:07:30.826690Z [info     ] Would insert                   path=/tmp/tmpop4820rz/archives/server1/2026/01/test.json.gz server=test time_from=2026-01-01T00:00:00Z
PASSED
...
tests/test_export_pagination.py::test_deep_pagination_no_same_ms_loss_or_dup 2026-07-12T08:07:31.413560Z [info     ] Total messages to fetch        total=6
2026-07-12T08:07:31.414040Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=4 new_from='2024-01-01 00:00:00.003000' old_from='2024-01-01 00:00:00'
PASSED
tests/test_export_pagination.py::test_deep_pagination_multiple_windows 2026-07-12T08:07:31.417774Z [info     ] Total messages to fetch        total=30
2026-07-12T08:07:31.419340Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=6 new_from='2024-01-01 00:00:00.005000' old_from='2024-01-01 00:00:00'
2026-07-12T08:07:31.420650Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=11 new_from='2024-01-01 00:00:00.010000' old_from='2024-01-01 00:00:00.005000'
2026-07-12T08:07:31.422402Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=16 new_from='2024-01-01 00:00:00.015000' old_from='2024-01-01 00:00:00.010000'
2026-07-12T08:07:31.423497Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=21 new_from='2024-01-01 00:00:00.020000' old_from='2024-01-01 00:00:00.015000'
2026-07-12T08:07:31.424632Z [info     ] Advancing time window for deep pagination carry=1 fetched_so_far=26 new_from='2024-01-01 00:00:00.025000' old_from='2024-01-01 00:00:00.020000'
PASSED
tests/test_export_pagination.py::test_pagination_raises_on_unsplittable_ms 2026-07-12T08:07:31.428583Z [info     ] Total messages to fetch        total=10
PASSED
...
tests/test_export_pagination.py::test_transient_5xx_fails_over_to_next_host 2026-07-12T08:07:31.444648Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-12T08:07:31.449828Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-12T08:07:31.452504Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-12T08:07:31.454142Z [info     ] Failover to host               host=http://host1:9200
PASSED
tests/test_export_pagination.py::test_all_hosts_transient_raises 2026-07-12T08:07:31.464513Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=1 status=503 wait=1
2026-07-12T08:07:31.465842Z [warning  ] Transient error, retrying      host=http://host0:9200 retry=2 status=503 wait=2
2026-07-12T08:07:31.466080Z [warning  ] Transient errors exhausted, failing over to next host host=http://host0:9200 status=503
2026-07-12T08:07:31.466212Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=1 status=503 wait=1
2026-07-12T08:07:31.466370Z [warning  ] Transient error, retrying      host=http://host1:9200 retry=2 status=503 wait=2
2026-07-12T08:07:31.466511Z [warning  ] Transient errors exhausted, failing over to next host host=http://host1:9200 status=503
PASSED
...
tests/test_health_guard.py::test_pause_then_resume 2026-07-12T08:07:31.706403Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 95%（超過硬上限 90%）']
2026-07-12T08:07:31.706581Z [info     ] export resumed — backpressure cleared waited_sec=1
PASSED
tests/test_health_guard.py::test_pause_times_out_and_raises 2026-07-12T08:07:31.709298Z [warning  ] export paused — Graylog backpressure signals=['JVM heap 99%（超過硬上限 90%）']
2026-07-12T08:07:31.709456Z [error    ] export stopped — backpressure did not clear signals=['JVM heap 99%（超過硬上限 90%）'] waited_sec=60
PASSED
...
tests/test_integration.py::test_archive_write_read_integrity 2026-07-12T08:07:33.107133Z [info     ] Archive written                messages=50 path=/tmp/tmppva_miti/test/stream1/2026/01/01/test_stream1_20260101T000000Z_20260101T010000Z_001.json.gz size_mb=0.00
PASSED
...
tests/test_integrity.py::test_verifier_flags_tampered 2026-07-12T08:07:34.193180Z [info     ] Verification started           total_archives=1
2026-07-12T08:07:34.194381Z [error    ] TAMPERED archive (HMAC mismatch) archive_id=1 path=/tmp/pytest-of-root/pytest-142/test_verifier_flags_tampered0/a.json.gz
2026-07-12T08:07:34.200972Z [info     ] Verification completed         corrupted=0 missing=0 orphans=0 tampered=1 total=1 valid=0
PASSED
...
tests/test_storage_ownership.py::test_fix_dir_ownership_as_root 2026-07-12T08:07:47.240022Z [warning  ] Fixing directory ownership     new_owner=jt-glogarch path=/tmp/tmpjk76z57p/archives/log4
PASSED
...
======================= 260 passed, 1 skipped in 22.95s ========================
```

## Version Check

```
Canonical version: 1.13.11
OK: version '1.13.11' has exactly one source of truth.
```
